...
const LAWS = [
...

  {
    ...
    history: `Al-Khwārizmī's *al-Kitāb al-mukhtaṣar fī ḥisāb al-jabr wa-l-muqābala* (c. 820 CE) gave us the word "algebra" — *al-jabr* meaning "restoring" a balanced equation by moving terms across the equals sign. François Viète (1591) was the first to use letters for unknown quantities. Évariste Galois had spent three years working out group theory when, expecting to die in a duel the next morning, he wrote a frantic letter begging a friend to preserve the manuscripts. He died at twenty; Liouville finally printed the work in 1846, and the mathematical world took decades more to absorb it.`,
  },

  {
    ...
    eli5: `Take e — the number that describes compound interest, population growth, and radioactive decay. Now raise it to the power iπ, which sounds like pure nonsense. The answer is exactly −1. Not a decimal, not an approximation: exactly negative one. Euler's identity links five numbers that seem to live in completely separate rooms of mathematics — e (growth), π (circles), i (the square root of minus one), 0, and 1 — in a single eight-character line. Mathematicians have called it the most beautiful equation ever written, and they are not being dramatic.`,
...

  {
    ...
    deps: ['probability', 'calculus'], sim: 'clt',
...

  {
    ...
    equation: '\\underbrace{\\delta_\\epsilon\\mathcal{L}=0}_{\\text{symmetry}}\\;\\Longrightarrow\\;\\underbrace{\\partial_\\mu j^\\mu=0}_{\\text{conserved current}}',
    ...
    surprise: `If the laws of physics were perfectly symmetric between matter and antimatter, the Big Bang would have produced equal amounts of both — and they would have annihilated each other, leaving a universe of nothing but light. Every star, galaxy, and atom owes its existence to a single broken symmetry in the weak nuclear force: one extra matter particle survived for every billion that annihilated. The universe is what's left of a near-perfect cancellation.`,
...

  {
    ...
    surprise: `A beam of light refracting into water picks the fastest of infinitely many possible paths — with no eyes, no compass, no foreknowledge of the water ahead. That is Fermat's principle of least time, the action principle written out for a photon: every refraction you have ever seen is nature solving a variational problem in real time.`,
...

  {
    ...
    intermediate: `The thermodynamic laws emerged from studying steam engines but govern everything that flows, burns, or changes. The zeroth establishes that temperature is consistent: two objects each in thermal equilibrium with a third are in equilibrium with each other — temperature can be meaningfully compared. The first is energy conservation: you cannot create energy, only convert it; you can never get out more than you put in. The second is the deep one: entropy — a count of how many microscopic arrangements of atoms produce the same macroscopic state — never decreases in an isolated system. Disordered configurations so vastly outnumber ordered ones that systems statistically drift toward disorder, as surely as any dropped object falls. The third says entropy approaches its minimum as temperature approaches absolute zero. But the second law has the deepest reach: it is why heat flows from hot to cold and never back, why gas expands into a vacuum but never spontaneously contracts, why the past is irrecoverably different from the future. The universe is not winding down; it is spreading out.`,
...

  {
    ...
    deps: ['thermo', 'probability', 'newton'], sim: 'statmech',
...

  {
    ...
    deps: ['thermo', 'statmech'], sim: 'stefan_boltzmann',
...

  {
    ...
    surprise: `Jacques Charles flew the first hydrogen balloon in 1783, and soon after found that a gas expands in exact proportion to its absolute temperature — yet he had no idea why. It took another 75 years, until Maxwell and Clausius worked out kinetic theory, to reveal that temperature is simply the average kinetic energy of molecules. The law was used for three generations before anyone understood what it meant.`,
...

  {
    ...
    surprise: `Maxwell died of stomach cancer in November 1879, aged 48 — eight years before Heinrich Hertz produced and detected the electromagnetic waves his equations had predicted. Radio, radar, television, mobile phones, Wi-Fi: he wrote the mathematics for all of them, and did not live to see a single one.`,
...

  {
    ...
    surprise: `Drop a strong magnet through a non-magnetic copper pipe and it falls in slow motion — hovering as if through honey — because the changing flux induces ring-shaped eddy currents in the copper that push back against the descent. Nothing attracts it; nothing touches it. That is Lenz's law made tangible, and you can replicate it with a plumbing offcut.`,
...

  {
    ...
    deps: ['maxwell', 'action'], sim: 'snells_law',
  ...
  {
    id: 'equivalence', name: 'Equivalence Principle', domain: 'relativity', symbol: 'mᵢ ≡ m',
    tagline: "Einstein's happiest thought: gravity is just acceleration.",
    equation: 'm_i = m_g \\;\\Longleftrightarrow\\; \\mathbf{a}_{\\text{fall}} = \\mathbf{g}',
    deps: ['gravity', 'special'], sim: 'equivalence',
    eli5: `Imagine you wake up in a windowless lift. You feel your normal weight, pressing your feet down. Are you on Earth — or are you inside a rocket out in deep space, being shoved forward by its engines? Einstein had a wild thought: there is *no* experiment you could do inside the lift to tell the difference. Being pulled by gravity feels exactly the same as being pushed by a rocket. So gravity isn't really a "force" tugging on you. It's just what space and time look like when something heavy is nearby.`,
    intermediate: `Mass shows up in physics in two seemingly unrelated places. *Inertial mass* m_i is how stubborn an object is — the m in F = m·a, how hard you must push to accelerate it. *Gravitational mass* m_g is what feels gravity — the m in F = m·g, what the Earth tugs on. There's no a priori reason these should be the same number, yet every experiment ever done says they are, to fifteen decimal places. Drop a hammer and a feather together in a vacuum and they hit the ground at the same instant. Einstein turned this coincidence into a principle: locally, gravity and acceleration are *literally the same thing*. A freely falling observer feels no weight at all; what we call gravity is just the floor of the world pushing us off the straight path we'd otherwise follow. From that one observation, eight years of work, and the whole of general relativity tumbled out.`,
    expert: `Three layers, in increasing strength: (1) the **weak equivalence principle** (WEP) — universality of free fall: all test bodies in a gravitational field accelerate identically regardless of composition, i.e. m_i ≡ m_g for every material. (2) The **Einstein equivalence principle** (EEP) adds local Lorentz invariance and local position invariance: in any sufficiently small spacetime region, the non-gravitational laws of physics reduce to special relativity in a freely falling frame. (3) The **strong equivalence principle** (SEP) extends EEP to include gravitational self-energy, distinguishing GR from most scalar-tensor alternatives. WEP has been confirmed to η ≡ |Δa/a| < 10⁻¹⁵ by the MICROSCOPE satellite (final results 2022) using two concentric cylinders of platinum-rhodium and titanium in free fall around Earth; the lunar laser ranging programme bounds SEP-violating Nordtvedt effects to comparable precision (η_N ≈ 3 × 10⁻¹⁴). Pound and Rebka (1959) measured gravitational redshift in a 22.5 m Harvard tower using Mössbauer-narrowed ⁵⁷Fe γ-rays to 1%; modern optical atomic clocks resolve the redshift over a single centimetre of height. EEP forces the metric formulation of gravity: locally inertial frames exist at every point, free-fall worldlines are timelike geodesics of a Lorentzian manifold, and the affine connection Γ^λ_μν is fixed by torsion-free metric compatibility (Levi-Civita). Open questions: does the principle hold for quantum superpositions of mass eigenstates? Antimatter? Galileo-style drop tests on antihydrogen (ALPHA-g, AEgIS, GBAR) returned the first results in 2023 and confirmed normal gravitational free fall at the 20% level — a direct empirical foothold against speculative anti-gravity scenarios.`,
    surprise: `In 1971, Apollo 15 commander David Scott stood on the Moon, held out a 1.32 kg geological hammer and a 0.03 kg falcon feather, and let go. With no air to slow the feather, both hit the regolith at exactly the same instant — Galileo's 350-year-old claim, finally proven on live television in a vacuum the size of a moon.`,
    history: `Galileo argued in his 1638 *Discorsi* that bodies of different weights fall together — the Pisa Tower drop is probably a later legend, though he did roll balls down inclined planes to make the point. Newton checked the principle with pendula to about one part in 10³ and called it out explicitly in the *Principia*. Loránd Eötvös spent 1885–1908 in Budapest refining a torsion balance to one part in 10⁹ — a precision unrivalled for half a century. In November 1907, while writing a review of relativity in the Bern patent office, Einstein had what he later called "the happiest thought of my life": a man falling freely from a roof feels no weight. From that single insight he built general relativity over the next eight years. The MICROSCOPE satellite finished operations in 2018 and reported in 2022 that m_i and m_g agree to better than one part in 10¹⁵ — the most precisely confirmed equality in all of physics.`,
  },
...

  {
    ...
    deps: ['quantum', 'maxwell'], sim: 'photoelectric',
...

  {
    ...
    surprise: `An atom is about 99.9999999999% empty space. Strip that void out of every atom in every human being alive today and all eight billion of us would fit inside a single sugar cube — still carrying the species' full five hundred million tonnes.`,
...

  {
    ...
    equation: '\\text{Aufbau: }\\;1s,\\,2s,\\,2p,\\,3s,\\,3p,\\,\\underbrace{4s,\\,3d}_{n+\\ell\\text{ rule}},\\,4p,\\,5s,\\,\\ldots',
  ...
  {
    id: 'landauer', name: "Landauer's Principle", domain: 'info', symbol: 'kT ln 2',
    tagline: 'Forgetting a bit costs a puff of heat.',
    equation: 'E_{\\text{erase}} \\;\\geq\\; k_{\\mathrm{B}} T \\ln 2',
    deps: ['information', 'thermo'], sim: null,
    eli5: `Every laptop runs a little warm. Why? Because *forgetting* things has a price. When your computer wipes a bit — turns a 1 into a 0 and loses the original — physics itself charges a toll: a tiny puff of heat, exactly the right size to keep the universe's books balanced. Rolf Landauer worked out how big the toll is, and it turns out to be beautifully small and beautifully unavoidable. Copying a bit? Free. Adding two bits? Free, in principle. But *erasing* a bit — throwing information away — costs at least a fixed sliver of heat, no matter how cleverly you design the machine. Information and heat, it turns out, are the same coin.`,
    intermediate: `In 1961 IBM physicist Rolf Landauer asked a deceptively simple question: what is the minimum energy a computation must burn? He noticed that logically **reversible** operations — ones you could in principle undo — have no thermodynamic lower bound; you can push them arbitrarily close to zero cost. But logically **irreversible** operations, like erasing a bit or merging two possible states into one, must dissipate at least *k*T ln 2 of energy per bit as heat, where *k* is Boltzmann's constant and T is the temperature of the surroundings. At room temperature that's about 3 × 10⁻²¹ joules per bit — vanishingly small, but non-zero and inescapable. The reason is thermodynamic bookkeeping: erasing a bit reduces the abstract entropy of your memory, and the second law demands the physical entropy of the world outside rise by exactly the same amount, or more. Today's transistors burn a few million times this floor, so we have head-room; but the floor is real, and if computers keep getting more efficient, they will meet it before the century is out.`,
    expert: `Landauer's bound: irreversibly erasing one bit at temperature T dissipates at least ΔQ_min = k_B T ln 2 ≈ 2.87 × 10⁻²¹ J at 300 K. Derivation: a two-state memory in an unknown state has Shannon entropy ln 2 nats; resetting it to a known reference collapses the phase space by that factor, and the Clausius inequality ΔS_env ≥ −ΔS_sys forces the environment's entropy to rise by ≥ k_B ln 2, deposited as heat ΔQ = TΔS. Charles Bennett (1973, 1982) used this to exorcise Maxwell's demon: the demon's memory must eventually be erased, and the dissipation of that erasure repays exactly the entropy the demon appeared to steal. Reversible computation is therefore in principle unbounded in energy efficiency — Bennett constructed a reversible Turing machine explicitly; Fredkin and Toffoli built universal reversible gate sets. Direct experimental verification came in 2012 (Bérut et al., *Nature*), using a colloidal silica bead in a double-well optical trap as a one-bit memory: measured dissipation converged on k_B T ln 2 as the erasure protocol was slowed to quasi-static. Jun et al. (2014) tightened the fit to within a few percent; Yan et al. (2018) confirmed the analogue at the quantum level. Reeb and Wolf (2014) derived finite-reservoir corrections. Frontier: sub-Landauer information engines that extract work from a heat bath by *reading* rather than erasing, obeying the generalised Jarzynski–Sagawa–Ueda relation ⟨e^{−βW − I}⟩ = 1, which encodes the demon and the erasure toll in one line.`,
    surprise: `A perfectly reversible computer would need no energy at all — you could in principle run it forever on a single charged battery. It's *forgetting* that costs. Every time your laptop overwrites a memory cell, the universe presents a bill of 2.9 × 10⁻²¹ joules per bit and refuses to negotiate.`,
    history: `Rolf Landauer — a Jewish boy who fled Stuttgart for New York in 1938, a Harvard PhD by 24, an IBM Fellow by 36 — published "Irreversibility and Heat Generation in the Computing Process" in the *IBM Journal of Research and Development* in 1961. It was almost entirely ignored for a decade. Then his IBM colleague Charles Bennett picked it up in 1973 and used it to lay Maxwell's demon to rest, showing that the demon's memory erasure pays exactly the thermodynamic debt the demon seemed to dodge. Landauer's motto — "information is physical" — became a rallying cry for the physics of computation. He died in 1999. Thirteen years later, in a Lyon lab, Antoine Bérut and colleagues finally saw a single silica bead pay the toll under a laser tweezer: k_B T ln 2, measured, fifty-one years after Landauer wrote it down.`,
  },
...

  {
    ...
    deps: ['emergence', 'computation'], sim: 'complexity',
...

  {
    ...
    surprise: `Walk across a room and you pass through trillions of dark-matter particles like a ghost — meanwhile, the empty space around you is quietly *manufacturing* dark energy. Its density stays constant as space expands, so the total grows from nothing, faster every year. Ninety-five percent of the universe is two completely different unknowns, and both of them are pervading the room you're sitting in right now.`,
...

  {
    ...
    equation: '\\underbrace{\\mathcal{C}}_{\\text{prebiotic chemistry}} \\;\\xrightarrow{\\,?\\,}\\; \\underbrace{\\mathcal{R}}_{\\text{self-replicator}}',
...

  {
    ...
    deps: ['bigbang', 'standard', 'general'], sim: 'stars',
...
const IMAGES = {
  ...
  calculus:      { image: WM('Gottfried_Wilhelm_Leibniz_c1700.jpg'),
                   caption: 'Gottfried Wilhelm Leibniz — co-invented calculus and its notation' },
  probability:   { image: WM('Pierre-Simon_Laplace.jpg'),
  ...
  ideal_gas:     { image: WM('Maxwell-Boltzmann_distribution.svg'),
  ...
  equivalence:   { image: WM('Elevator_gravity.svg'),
                   caption: "Einstein's elevator: a ball falling in an accelerating rocket (left) is indistinguishable from one falling on Earth (right)" },
  general:       { image: WM('Black_hole_-_Messier_87_crop_max_res.jpg'),
                   caption: 'M87* — first-ever image of a black hole (EHT, 2019)' },
  grav_waves:    { image: WM('LIGO_Hanford_aerial_05.jpg'),
  ...
  periodic:      { image: WM('Dmitri_Mendeleev.jpg'),
  ...
  kolmogorov:    { image: WM('%D0%9C%D0%B0%D1%82%D0%B5%D0%BC%D0%B0%D1%82%D0%B8%D0%BA%20%D0%90%D0%BD%D0%B4%D1%80%D0%B5%D0%B9%20%D0%9A%D0%BE%D0%BB%D0%BC%D0%BE%D0%B3%D0%BE%D1%80%D0%BE%D0%B2%20%D0%B2%20%D0%B0%D1%83%D0%B4%D0%B8%D1%82%D0%BE%D1%80%D0%B8%D0%B8.jpg'),
                   caption: 'Andrey Kolmogorov — measure-theoretic probability, turbulence, and the absolute information of a string' },
  landauer:      { image: WM('Rolf_Landauer.jpg'),
                   caption: "Rolf Landauer — 'information is physical' (IBM Research)" },
  emergence:     { image: WM('A_starling_murmuration_-_geograph.org.uk_-_6389346.jpg'),
  ...
  dark_nature:        { image: WM('1e0657_scale.jpg'),
                        caption: 'The Bullet Cluster — dark matter separated by lensing' },
  dark_energy_nature: { image: WM('SN1994D.jpg'),
  ...
  arrow_of_time:      { image: WM('Arthur_Stanley_Eddington.jpg'),
                        caption: 'Arthur Eddington — coined "the arrow of time" in 1927' },
